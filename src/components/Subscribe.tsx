    ...
    return(
        <div className='w-96 py-6 px-8 rounded-3xl bg-red-300 text-white shadow-md'>
            <div className='flex relative'>
                <p className='text-[22px] cursor-default'>Get a Lovly App Link</p>
                <button className='text-lg p-0 text-white opacity-60 hover:opacity-100 transition-all absolute top-0 right-0'>
                    <Close />
                </button>
            </div>
            
            <p className='text-start mb-7 cursor-default'>Subscribe and receive our newsletters to follow the news about our fresh.</p>
